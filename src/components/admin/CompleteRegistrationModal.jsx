...
export default function CompleteRegistrationModal({ isOpen, onClose, appointment, onSuccess }) {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-3">
      <div className={`bg-white rounded-lg p-4 w-full max-w-2xl ${registrationMode === "ipad" && !isInternational ? "max-h-[95vh] overflow-hidden" : "max-h-[90vh] overflow-y-auto"}`}>
        <div className="flex justify-between items-center mb-2">
          <h2 className="text-lg font-bold text-gray-800">Zakończ rejestrację pacjenta</h2>
        ...
        {!(registrationMode === "ipad" && !isInternational) && (
          <p className="text-sm text-gray-600 mb-3">Wybierz sposób rejestracji pacjenta dla tej wizyty.</p>
        )}
