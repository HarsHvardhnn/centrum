...
import { FaSearch, FaStar, FaPhone, FaShieldAlt } from "react-icons/fa";
...
export default function Hero({selectedDoctorId, setSelectedDoctorId}) {
  ...
  const handleCall = () => {
    window.location.href = "tel:+48797097487";
  };

  return (
    <section className="bg-[#F0F7F7] relative flex flex-col items-center pt-12 sm:pt-16 pb-16 sm:pb-20 md:pb-24 lg:pb-28">
      <div className=" flex-1 flex flex-col md:flex-row items-center justify-between px-4 sm:px-10 xl:px-20 pt-8 sm:pt-16">
        ...
        <div className="md:w-1/2 text-center md:text-left mb-10 md:mb-0 md:pr-40 lg:pr-48 xl:pr-56">
          ...
          <div className="mt-8 md:mt-6 relative z-10 bg-white rounded-2xl shadow-xl p-6 pb-6 max-w-md mx-auto md:mx-0">
            {/* Teal Pill Tag */}
        ...
        <div className="md:w-1/2 relative z-0 flex justify-center items-center">
          ...
          {!isMobile && (
            <div className="relative z-10 w-full max-w-[600px] xl:max-w-[700px]">
              <div className="relative rounded-2xl shadow-2xl bg-white border-4 border-white overflow-visible">
                ...
                {/* Google Review Widget - positioned at bottom border, slightly more outside */}
                <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 translate-y-[60%] bg-white rounded-lg px-4 py-2 shadow-lg flex items-center gap-2 border border-gray-200 z-20">
        ...
        {isMobile && (
          <div className="relative z-10 w-full max-w-[600px] mt-8">
            <div className="relative rounded-2xl shadow-2xl bg-white border-4 border-white overflow-visible">
              ...
              {/* Google Review Widget - positioned at bottom border, slightly more outside */}
              <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 translate-y-[60%] bg-white rounded-lg px-3 py-1.5 shadow-lg flex items-center gap-1.5 border border-gray-200 z-20">
                {/* Google Logo - Teal color */}
                ...
                <div className="flex items-center gap-0.5">
                  {[...Array(5)].map((_, i) => (
                    <FaStar key={i} className="text-yellow-400 text-xs fill-yellow-400" />
                  ))}
                </div>
                {/* Rating Text */}
