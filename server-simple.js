  ...
  switch (path) {
    ...
    default:
      ...
      if (path.startsWith('/aktualnosci/')) {
        ...
        title = `${slug.replace(/-/g, ' ')} | Aktualności – CM7`;
...
<head>
    ...
    <meta property="og:site_name" content="CM7">
