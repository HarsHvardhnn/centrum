        ...
        <div className="w-full lg:w-1/2">
          <Slider {...settings}>
            {testimonialsData.map((testimonial) => (
              <div key={testimonial.id} className="bg-white shadow-lg rounded-2xl p-8 md:p-12 h-auto border border-neutral-400">
                <div className="flex items-center justify-between gap-4">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-neutral-600 text-sm">{testimonial.date}</p>
                    </div>
                  </div>
                ...
                <p className="text-neutral-900 text-lg md:text-xl mt-6 md:mt-10">{testimonial.text}</p>
              </div>
            ))}
          </Slider>
        </div>
