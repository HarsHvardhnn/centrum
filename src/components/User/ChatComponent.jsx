...
export default function ChatComponent() {
  ...
  return (
    <div className="w-full max-w-2xl mx-auto border rounded-md shadow-md flex flex-col h-[80vh]">
      ...
      <div className="flex items-center gap-6 p-3 border-t border-gray-300 bg-white">
        <input
