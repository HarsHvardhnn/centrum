      ...
      <div className="flex justify-between items-center px-6 md:px-8 py-3 bg-[#DEE2CF]">
        ...
        >
          ...
          <div className="flex flex-col items-center gap-3 mt-6">
            <button className="bg-teal-800 text-white w-32 py-2 text-sm rounded-full">
              Log in
            </button>
            <button className="border border-teal-700 text-teal-700 w-32 py-2 text-sm rounded-full">
              Sign up
            </button>
          </div>
        </div>
