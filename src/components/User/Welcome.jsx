...
export default function Welcome() {
  return (
    <section className="py-12 text-center bg-white px-4 md:px-8 lg:px-16">
      <h3 className="font-bold text-xl text-neutral-800 uppercase">Witamy w Centrum Medycznym</h3>
      <h2 className="text-3xl md:text-4xl font-bold font-serif text-main mt-2">
        Doskonałe miejsce do otrzymania opieki
      </h2>
      <p className="max-w-3xl mx-auto text-neutral-900 text-lg md:text-xl mt-4">
        Zapewniamy kompleksową opiekę medyczną na najwyższym poziomie, łącząc profesjonalizm z empatią.
      </p>
