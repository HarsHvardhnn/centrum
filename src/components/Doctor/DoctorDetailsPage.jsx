...
import { useParams } from "react-router-dom"; // or "react-router-dom" depending on your setup
  ...
  const transformDoctorData = (apiDoctor) => {
    ...
    return {
      ...
      times: [
        ...
        "04:00 pm",
        "04:30 pm",
      ], // Default times or get from API if available
