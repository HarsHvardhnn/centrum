  ...
  return (
    <div className="container mx-auto px-4 py-6 bg-gray-50 min-h-screen">
      ...
      <div className="flex items-center mb-6 text-sm">
        <button onClick={handleGoBack} className="text-teal-500 mr-2">
          <ArrowLeft size={18} />
        </button>
        <span
        ...
        <div className="flex flex-col md:flex-row">
          ...
          <div className="w-full md:w-1/3 md:border-r border-gray-100 p-6">
            ...
            <div className="w-full flex  items-center">
              ...
              <div className="bg-teal-50 rounded-lg p-4 w-1/2">
                ...
                <div className="bg-white rounded-md p-2 mb-2 text-sm">
                  Room Number: 28B
                </div>

                <div className="bg-white rounded-md p-2 mb-2 text-sm flex items-center justify-between">
                ...
                <div className="bg-white rounded-md p-2 text-sm flex items-center justify-between">
                  <div className="flex items-center">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-teal-50 p-3 rounded-lg">
                ...
                <div className="relative w-full h-1.5 bg-gray-200 rounded-full mt-1">
                  <div
                    className="absolute h-1.5 bg-teal-400 rounded-full"
                    style={{ width: "30%" }}
                  ></div>
                </div>
          ...
          <div className="w-full md:w-2/3 p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                <label className="block text-sm text-gray-600 mb-1">
                  Konsultacja stacjonarna w klinice
                </label>
              ...
              {/* Action Buttons */}
              <div className="col-span-1 md:col-span-2 grid grid-cols-2 md:grid-cols-4 gap-3 mt-4">
                <button className="flex items-center justify-center border border-gray-200 rounded-lg p-2 text-sm">
                  <svg
                    width="16"
                    height="16"
                    viewBox="0 0 24 24"
                ...
                <button className="flex items-center justify-center bg-teal-100 text-teal-600 rounded-lg p-2 text-sm">
                  <svg
                    width="16"
                    height="16"
                    viewBox="0 0 24 24"
                ...
                <button className="flex items-center justify-center border border-gray-200 rounded-lg p-2 text-sm col-span-1">
                  <svg
                    width="16"
                    height="16"
                    viewBox="0 0 24 24"
              ...
              <div className="col-span-1 md:col-span-2 flex justify-end mt-3">
                <button className="bg-teal-500 text-white px-6 py-2 rounded-lg text-sm">
                  Save
                </button>
              </div>
            </div>
